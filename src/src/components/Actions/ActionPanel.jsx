    ...
    case 'construire':
      return (
        <div style={{ display:'flex', flexDirection:'column', gap:4 }}>
          <ActionConstruire onClose={handleClose} onMarkUsed={onMarkUsed} onTileHighlight={onTileHighlight} constructTileClicked={constructTileClicked} onConstructTileHandled={onConstructTileHandled} />
        </div>
      )
    case 'explorer':
      return (
